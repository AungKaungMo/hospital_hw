        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 m-auto">
            <div
                ...
                <div class=" space-y-4 md:space-y-6 sm:p-8 ">
                    ...
                    <form class="space-y-4 md:space-y-6 w-96 m-auto mt-5" method="POST" action="/signup">
                        @csrf
                        @error('username')
                        ...
                        <button type="submit"
                            class="w-full p-2 bg-slate-500 text-white  font-bold bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">{{ __('message.signacc') }}
                        </button>
                        <p class="mb-5 text-sm font-light text-gray-500 dark:text-gray-400">
                            {{ __('message.haveacc') }} <a href="/"
                                class="font-medium text-primary-600 hover:underline dark:text-primary-500">{{ __('message.sign') }}</a>
                        </p>
                    </form>
                </div>
            </div>
